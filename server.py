...
class Server(socket):
    ...
    def forever_serve(self):
        ...
        try:
            while True:
                ...
                info_len = struct.pack('6i',len(snakes_info),food.color[0],food.color[1],food.color[2],food.pos[0],food.pos[1])
    ...
    def _handle_link(self):
        while True:
            ...
            one_client = gevent.spawn(self._client_handle,client)
